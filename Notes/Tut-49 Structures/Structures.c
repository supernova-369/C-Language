...
/*
fgets() does NOT store just the word.
It also stores the newline character when you press Enter.
*/
...
Then the array actually contains:

bucky\n\0


That means this comparison is happening internally:
